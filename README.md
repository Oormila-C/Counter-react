...
* Prevents the counter value from going below zero
* Displays **"Minimum limit reached"** when the counter is zero using conditional rendering
* Dynamic UI updates without page refresh
* Simple and responsive user interface with separate CSS styling
